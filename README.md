...
Write tools: `set_fcu`, `set_autoflight`, `set_lights`, `set_brightness`, `set_antiice`, `set_pneumatic`, `set_electrical`, `set_fuel`, `set_hydraulic`, `set_radio`, `set_acp`, `set_atc`, `set_pedestal`, `set_efis`, `set_ecam`, `set_weather_radar`.
